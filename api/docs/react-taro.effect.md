...
[Home](./index.md) &gt; [@elux/react-taro](./react-taro.md) &gt; [effect](./react-taro.effect.md)
...
|  --- | --- | --- |
|  loadingKey | string \| null | 将该 effect 执行状态作为 [LoadingState](./react-taro.loadingstate.md) 注入指定的 ModuleState 中。 |
