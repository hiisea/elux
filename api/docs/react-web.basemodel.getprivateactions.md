...
{ \[K in keyof T\]: [HandlerToAction](./react-web.handlertoaction.md)<!-- -->&lt;T\[K\]&gt;; } &amp; { \_initState(state: TModuleState): [Action](./react-web.action.md)<!-- -->; \_updateState(subject: string, state: Partial&lt;TModuleState&gt;): [Action](./react-web.action.md)<!-- -->; \_loadingState(loadingState: { \[group: string\]: [LoadingState](./react-web.loadingstate.md)<!-- -->; }): [Action](./react-web.action.md)<!-- -->; }
