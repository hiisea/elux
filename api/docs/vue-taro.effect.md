...
[Home](./index.md) &gt; [@elux/vue-taro](./vue-taro.md) &gt; [effect](./vue-taro.effect.md)
...
|  --- | --- | --- |
|  loadingKey | string \| null | 将该 effect 执行状态作为 [LoadingState](./vue-taro.loadingstate.md) 注入指定的 ModuleState 中。 |
