...
[Home](./index.md) &gt; [@elux/vue-taro](./vue-taro.md) &gt; [getApi](./vue-taro.getapi.md)
...
Pick&lt;TAPI, 'GetActions' \| 'LoadComponent' \| 'Modules'&gt; &amp; { GetClientRouter: () =&gt; [IRouter](./vue-taro.irouter.md)<!-- -->; useRouter: () =&gt; [IRouter](./vue-taro.irouter.md)<!-- -->; useStore: () =&gt; [IStore](./vue-taro.istore.md)<!-- -->&lt;TAPI\['State'\]&gt;; }

返回包含多个全局方法的结构体：

- `LoadComponent`<!-- -->：用于加载其它模块导出的[UI组件](./vue-taro.exportview.md)<!-- -->，参见 [ILoadComponent](./vue-taro.iloadcomponent.md)<!-- -->。

- `Modules`<!-- -->：用于获取所有模块的对外接口，参见 [ModuleFacade](./vue-taro.modulefacade.md)<!-- -->，例如：
