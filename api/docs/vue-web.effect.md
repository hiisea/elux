...
[Home](./index.md) &gt; [@elux/vue-web](./vue-web.md) &gt; [effect](./vue-web.effect.md)
...
|  --- | --- | --- |
|  loadingKey | string \| null | 将该 effect 执行状态作为 [LoadingState](./vue-web.loadingstate.md) 注入指定的 ModuleState 中。 |
