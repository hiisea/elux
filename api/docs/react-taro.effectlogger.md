...
[Home](./index.md) &gt; [@elux/react-taro](./react-taro.md) &gt; [effectLogger](./react-taro.effectlogger.md)
...
|  --- | --- | --- |
|  before | (store: [IStore](./react-taro.istore.md)<!-- -->, action: [Action](./react-taro.action.md)<!-- -->, effectResult: unknown) =&gt; void | 该 effect 执行前自动调用 |
