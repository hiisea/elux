...
[Home](./index.md) &gt; [@elux/vue-taro](./vue-taro.md) &gt; [effectLogger](./vue-taro.effectlogger.md)
...
|  --- | --- | --- |
|  before | (store: [IStore](./vue-taro.istore.md)<!-- -->, action: [Action](./vue-taro.action.md)<!-- -->, effectResult: unknown) =&gt; void | 该 effect 执行前自动调用 |
