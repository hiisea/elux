import { h, inject, defineAsyncComponent, watch, reactive, defineComponent as defineComponent$1, createApp as createApp$1, createSSRApp } from 'vue';
...
export { ActionTypes, ModuleWithRouteHandlers as BaseModuleHandlers, DocumentHead, EmptyModuleHandlers, Link, LoadingState, RouteActionTypes, action, clientSide, createApp, createRouteModule, createSsrApp, createVuex, deepMerge, deepMergeState, defineComponent, defineView, delayPromise, effect, env, errorAction, exportComponent, exportModule, exportView, getApp, isProcessedError, isServer, logger, mutation, patchActions, reducer, serverSide, setConfig, setLoading, setProcessedError, setSsrHtmlTpl };
