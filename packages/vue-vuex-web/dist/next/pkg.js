import { h, inject, defineAsyncComponent, defineComponent as defineComponent$1, createApp as createApp$1, createSSRApp, watch, reactive } from 'vue';
...
var DocumentHead = defineComponent$1({
  props: {
    title: {
      type: String,
      default: ''
...
const defineView = function (...args) {
  const view = defineComponent$1(...args);
  return exportView(view);
};
const defineComponent = function (...args) {
  const view = defineComponent$1(...args);
...
export { ActionTypes, ModuleWithRouteHandlers as BaseModuleHandlers, DocumentHead, EmptyModuleHandlers, Link, LoadingState, RouteActionTypes, action, clientSide, createApp, createLogger, createRouteModule, createSsrApp, createVuex, deepMerge, deepMergeState, defineComponent, defineView, delayPromise, effect, env, errorAction, exportComponent, exportModule, exportView, getApp, isProcessedError, isServer, logger, mutation, patchActions, reducer, serverSide, setConfig, setLoading, setProcessedError, setSsrHtmlTpl, useStore };
