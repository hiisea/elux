...
var createApp = function createApp(moduleGetter, storeMiddlewares, storeLogger) {
  ...
  return (0, _app.createBaseApp)({}, router, _stage.renderToDocument, storeMiddlewares, storeLogger);
};
...
var createSSR = function createSSR(moduleGetter, url, nativeData, storeMiddlewares, storeLogger) {
  ...
  return (0, _app.createBaseSSR)({}, router, _stage.renderToString, storeMiddlewares, storeLogger);
};
