...
[Home](./index.md) &gt; [@elux/react-redux-web](./react-redux-web.md) &gt; [effectLogger](./react-redux-web.effectlogger.md)
...
|  --- | --- | --- |
|  before | (action: [Action](./react-redux-web.action.md)<!-- -->, promiseResult: Promise&lt;any&gt;) =&gt; void |  |
