...
export class ModuleHandlers extends CoreModuleHandlers<State, {}> {
  ...
  protected async ['moduleA.add'](): Promise<void> {
    ...
    messages.push(['moduleC/moduleA.add', JSON.stringify(this.getRootState()), JSON.stringify(prevState)]);
  }
  ...
  protected async ['moduleA.add2'](): Promise<void> {
    ...
    messages.push(['moduleC/moduleA.add2', JSON.stringify(this.getRootState()), JSON.stringify(prevState)]);
  }
}
