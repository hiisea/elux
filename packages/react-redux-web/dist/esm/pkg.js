import React, { Component as Component$3, useContext, useEffect, useLayoutEffect, useMemo, useReducer, useRef, useDebugValue } from 'react';
        ...
        render: function render(_temp2) {
          ...
          return router.initedPromise.then(function (routeState) {
            ...
            return ssrApp(baseStore, Object.keys(routeState.params), istoreMiddleware, viewName).then(function (_ref7) {
              ...
              var html = require('react-dom/server').renderToString(React.createElement(EluxContext.Provider, {
                value: eluxContext
              }, React.createElement(RootView, {
                store: store
              })));
...
export { ActionTypes$1 as ActionTypes, ModuleWithRouteHandlers as BaseModuleHandlers, DocumentHead, Else, EmptyModuleHandlers, Link, LoadingState, RouteActionTypes, Switch, clientSide, connectAdvanced, connectRedux, createApp, createRedux, createRouteModule, createSelectorHook, createSsrApp, deepMerge, deepMergeState, delayPromise, effect, env, errorAction, exportComponent, exportModule, exportView, getApp, isProcessedError, isServer, logger, patchActions, reducer, serverSide, setConfig, setLoading, setProcessedError, setSsrHtmlTpl, shallowEqual, useSelector };
